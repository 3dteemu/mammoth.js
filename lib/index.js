...
function convert(input, options) {
    ...
    return unzip.openZip(input)
        .tap(function(docxFile) {
            console.log("tap: docxFile", docxFile);
            return docxStyleMap.readStyleMap(docxFile).then(function(styleMap) {
                console.log("tap: styleMap", styleMap);
        ...
        .then(function(docxFile) {
            return docxReader.read(docxFile, input)
                .then(function(documentResult) {
                    console.log("documentResult before transform", documentResult);
...
function convertDocumentToHtml(documentResult, options) {
    console.log("convertDocumentToHtml", documentResult, options);
